...
<div class="info">
	...
	<div class="right">
		...
		<ul>
			<li>Gearbox rating: 90HP</li>
			<li>6" Heavy Duty Side Band Channel</li>
			<li>Deck Material: 11 guage</li>
			<li>Approximate weight: 768lbs</li>
		...
		<ul>
			...
			<li>* 20ft Trailer is optional. Please call for pricing.</li>
		</ul>
